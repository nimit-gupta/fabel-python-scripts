...
def read_query():
    ...
    df['Computed'] = df.loc[:,['Lens Exempted Price','Lens Standard Price','Solution Price','Sunglasses Price','Glasses Exempted Price','Glasses Standard Price','EyeFrame Price','Shipping Before VAT','Total VAT']].sum(axis = 1)
