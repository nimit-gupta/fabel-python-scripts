...
def read_query():
    ...
    sql = '''
             ...
             where
                  ...
                  and ORL.CountryId NOT IN (1, 2, 10, 19)
                  and IsEU = 1
             group by
    ...
    client = pygsheets.authorize(service_account_file= "D:/Python_Deployments/FGC_Automation_Window_Server/FGC_Daily_EU_Orders_Report/client_secret.json")

    googlesheet = client.open("FGC_Daily_EU_Orders_Report_2021_22")

    worksheet = googlesheet.worksheet('title', 'Daily_EU_Orders_Details')
