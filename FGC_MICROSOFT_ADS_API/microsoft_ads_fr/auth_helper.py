...
REFRESH_TOKEN=r"D:\Python_Deployments\FGC_MICROSOFT_ADS_API\microsoft_ads_fr\refresh_fr.txt"
...
def authenticate(authorization_data):
    ...
    authorization_data.account_id=accounts['AdvertiserAccount'][1].Id
    authorization_data.customer_id=accounts['AdvertiserAccount'][1].ParentCustomerId
