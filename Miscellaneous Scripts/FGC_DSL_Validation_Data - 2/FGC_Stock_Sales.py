...
def read_query():
    ...
    query = '''
               SELECT 
                    ...
                    I.L3SALES	    as L3_Sales_Boxes,
                    J.L6SALES	    as L6_Sales_Boxes,
                    K.AS2021	    as Annual_Sales_Boxes_2021,
                    L.AS2020	    as Annual_Sales_Boxes_2020,
                    M.AS2019	    as Annual_Sales_Boxes_2019,
                    N.SL2021	    as Sales_Loss_Boxes_2021,
                    O.CO2021	    as Cancelled_Order_2021, 
                    DA.CapacityBoxes as ShippingCapacity,
                    DB.HoldingBoxes as HoldingBoxes
                FROM 
    ...
    client = pygsheets.authorize(service_file= 'C:/Users/Nimit/Desktop/VSCODE/Universal_Client_Secret.json')
