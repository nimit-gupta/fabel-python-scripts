...
def read_query():
    ...
    clFRnt = pygsheets.authorize(service_file= 'D:/Python_Deployments/FGC_FGCL_REPORT/Universal_Client_Secret.json')

    sh = clFRnt.open('FGC_FGCL_REPORT_2021_22')
    
    wks = sh.worksheet('title', 'FGC_FR')
