...
def web_scrap_href(soup):
    ...
    try:
        ...
        for html_tag_div in soup.find_all('div', class_ = 'col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding products-list_item contact-lenses'):
...
def beautiful_soup():
    ...
    for page_no in range(1, 2):
        ...
        response = requests.get("https://www.feelgoodcontacts.com/contact-lenses?page=" + str(page_no))
    ...
    df_contact_lenses = df.transpose()
   
    return df_contact_lenses
